...
async function getData(categorya, page=1) {
    let respons = await fetch(`https://api.themoviedb.org/3/movie/${categorya}?api_key=${API_KEY}&page=${page}`)
    let films = await respons.json()
